...
public class SimpleExecutor extends BaseExecutor {
  ...
  public <E> List<E> doQuery(MappedStatement mappedStatement, Object parameter, RowBounds rowBounds,
    ...
    try {
      ...
      // SQL处理的关键对象 StatementHandler，默认是PreparedStatementHandler，创建此对象时同时完成ParameterHandler和ResultSetHandler的创建
      ...
      stmt = prepareStatement(handler, mappedStatement.getStatementLog());
  ...
  @Override
  protected <E> Cursor<E> doQueryCursor(MappedStatement mappedStatement, Object parameter, RowBounds rowBounds,
